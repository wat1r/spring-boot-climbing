...
//                    nowQueryTable = nowQueryTable
    ...
    public static void main(String[] args) throws IOException, ParseException,
        ...
        String sql24 = "insert overwrite table dw.wod_character_deposit_bitmap_mid partition(part_date='${date}') select a,b from dw.t";
        String sql25 = "INSERT overwrite TABLE dm.mining_mir2x_shoprecom_exposed_his_test2 PARTITION (PART_DATE = '${date}')\n" +
                "SELECT a.game_id\n" +
                "\t,a.area_id\n" +
                "\t,a.group_id\n" +
                "\t,a.mid\n" +
                "\t,a.character_id\n" +
                "\t,CONCAT_WS('-', cast(a.area_id AS string), cast(a.group_id AS string), cast(a.mid AS string), cast(a.character_id AS string)) userid\n" +
                "\t,product_id\n" +
                "\t,count(1) num\n" +
                "FROM (\n" +
                "\tSELECT game_id\n" +
                ...
                "\t\t,character_id\n" +
                "\t\t,itemname product_id\n" +
                "\tFROM dw.cqxz_recommends_glog\n" +
                "\tWHERE part_date >= date_sub('${date}', 7)\n" +
                "\t\tAND opt_type = 1\n" +
                "\t) a\n" +
                "INNER JOIN (\n" +
                "\tSELECT game_id\n" +
                ...
                "\t\t,mid\n" +
                "\t\t,character_id\n" +
                "\tFROM dm.mining_mir2x_shoprecom_userprof\n" +
                ...
                "\t\t,character_id\n" +
                "\t) aa ON a.mid = aa.mid\n" +
                "\tAND a.area_id = aa.area_id\n" +
                "\tAND a.group_id = aa.group_id\n" +
                "\tAND a.character_id = aa.character_id\n" +
                "\tAND a.game_id = aa.game_id\n" +
                "where product_id>0    \n" +
                "GROUP BY a.game_id\n" +
                "\t,a.area_id\n" +
                "\t,a.group_id\n" +
